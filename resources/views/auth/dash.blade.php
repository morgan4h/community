...
<body>
        ...
        <section id="logs" class="dashboard-section">
            <div class="table-container" style="padding: 20px;">
                ...
                <div class="log-console" id="logConsole">
                    <div class="log-entry"><span class="log-timestamp">[2026-07-30 18:45:10]</span> SYSTEM: Admin panel initialized.</div>
                    <div class="log-entry"><span class="log-timestamp">[2026-07-30 18:46:02]</span> USER: New registration from IP 192.168.1.45.</div>
    ...
    <script>
        ...
        // MEDIA SUB-TABS (MOVIES vs STREAMS)
